...
/**
 * @file Geodistance.java
 * @brief Class to perform calculations of distance on the Earth's surface
 * @author michaelfoy
 * @version 2016-06-16
 */
public class Geodistance {
   ...
   * 
   * @param resLocn The coordinates for the point
   * @param circle The circle to be used
   * @return True if the point is within he circle
   */
   ...
   * http://www.movable-type.co.uk/scripts/latlon.js Calculates the distance between two points
   * (latitude, longitude) on spherical surface
   * 
  ...
  private static double haversine(LatLng p1, Circle circle) {
    LatLng center = circle.getCentre();
